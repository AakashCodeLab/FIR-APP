 ...
 if (form.Consignment.value == "" )
		 {
			...
			return false;
              ...
              <tbody><tr>
                <td class="TrackTitle" valign="top"><div class="newtext" align="center"><strong><font color="red"><h1>CLOSE THE FIR</h1></font><br>
                        </strong></div></td>
              </tr>
              
              <tr bgcolor="EFEFEF">
                <td class="aalpha" valign="top"><div align="center"><font color="blue"">ENTER THE UNIQUE FIR ID OF COMPLAINER</font></div></td>
              </tr>
              <tr bgcolor="EFEFEF">
            ...
            <form action="track-result.php" method="post" name="form" id="form" >
                  ...
                  <input name="Submit" type="submit" class="gentxt" onClick="MM_validateForm('Consignment','','R');return document.MM_returnValue" value="CLOSE">
            </form>
