		 ...
		 <div class="errorMessage" align="center"><?php echo $errorMessage; ?></div>
		  ...
		  <table width="100%" height="400" border="0" cellpadding="2" cellspacing="1" class="text">
           ...
           <tr class="text"> 
            ...
            <td><input name="txtUserName" type="text"  required="required" class="box" id="txtUserName"  size="30" maxlength="40"></td>
           </tr>
           <tr>
             <td align="right">Password</td>
             <td align="center">:</td>
             <td><input name="txtPassword" type="password" required="required" class="box" id="txtPassword" size="30" maxlength="40"></td>
           </tr>
           <tr> 
