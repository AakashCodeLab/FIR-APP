 ...
 if (form.Consignment.value == "" )
		 {
			...
			return false;
              ...
              <tbody><tr>
                <td class="TrackTitle" valign="top"><div class="newtext" align="center"><strong> <font color="blue"><h1>Close The FIR</h1></font><br>
                        </strong></div></td>
              </tr>
              <tr>
              ...
              <tr bgcolor="EFEFEF">
                <td class="aalpha" valign="top"><div align="center"><font color="red">ENTER YOUR UNIQUE FIR ID </font></div></td>
              </tr>
              <tr bgcolor="EFEFEF">
                <td valign="top"><div align="center">
            <form action="process.php?action=close" method="post" name="form" id="form" >
