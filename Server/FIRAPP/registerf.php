...
<html>
<head>
<title>Online FIR- User Register</title>
       ...
       <table width="600" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#336699" class="entryTable">
        ...
        <tr> 
		 ...
		 <div class="errorMessage" align="center"><?php echo $errorMessage; ?></div>
		  ...
		  <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
           <tr align="center"> 
            <td colspan="2"><div align="right"><a href="loginf.php">Back</a></div></td>
           </tr>
           <tr class="entryTable">
             <td class="label">&nbsp;User Name</td>
             <td class="content"><input required="required" name="txtUserName" type="text" class="box" id="txtUserName" size="30" maxlength="20"></td>
           </tr>
           <tr class="entryTable">
             <td class="label">&nbsp;Password</td>
             <td class="content"><input required="required" name="txtPassword"  type="password" class="box" id="txtPassword" value="" size="30" maxlength="20" /></td>
           </tr>
           <tr class="entryTable">
  	  ...
  	  <option value="complainer">&nbsp;&nbsp; Complainer &nbsp;</option>
           ...
           <tr class="entryTable">
             ...
             <td class="content"><textarea required="required" name="txtAdd" cols="40" rows="4" class="box" id="txtAdd"></textarea></td>
           </tr>
           <tr class="entryTable">
             <td class="label">&nbsp;Mobile No. </td>
             <td class="content"><input required="required" pattern="[7-9]{1}[0-9]{9}" name="txtMob" type="text" class="box" id="txtMob" value="" size="30" maxlength="20" /></td>
           </tr>
		   
           <tr class="entryTable">
             <td class="label"> &nbsp;E-mail</td>
            <td class="content"><input required="required" name="Email" type="email" class="box" id="Email" value="" size="30" maxlength="60"></td>
           </tr>
