...
<tbody><tr>
<td><img src="fir.gif" height="109" width="900"></td>
</tr>
<tr>
...
function validate()
 ...
 if (form.Consignment.value == "" )
		 {
			alert("Insert Your Unique FIR ID.");
			form.track.focus( );
			return false;
		}
else if(form.user.value=="")
{
	...
	return false;
              ...
              <tbody><tr>
                <td class="TrackTitle" valign="top"><div class="newtext" align="center"><strong> <font color="blue"><h1>CASE STATUS &nbsp;:&nbsp; CHECK BY THE FIR ID</h1></font><br>
                        </strong></div></td>
              </tr>
              <tr>
              ...
              <tr bgcolor="EFEFEF">
                <td class="aalpha" valign="top"><div align="center"><font color="red">ENTER YOUR USERNAME AND UNIQUE FIR ID </font></div></td>
              </tr>
              <tr bgcolor="EFEFEF">
                <td valign="top"><div align="center">
            <form action="track-result.php" method="post" name="form" id="form" >
			     USERNAME: <input name="username" class="gentxt" id="user" maxlength="50" type="text"> <br/><br/>
			     FIR ID: <input name="Coid" class="gentxt" id="Consignment" maxlength="50" type="text"> 
				...
				<tr>
				<td>
				<input type="submit" name="submit"class="gentxt"value="Back">
				</td>
				</tr>
              <tr bgcolor="EFEFEF">
                <td valign="top">&nbsp;</td>
