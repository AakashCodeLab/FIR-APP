  ...
  <tr>
    ...
    <td width="20%" valign="top" class="navArea"><p>&nbsp;</p>
 	<div id="ddblueblockmenu">
	  <div class="menutitle">Police Inspector View Menu</div>
		  <ul>
			<li><a href="/FIRSITE/">Welcome,&nbsp;<? echo ucwords($_SESSION['user_name']); ?></a></li>
			<li><a href="fir-list.php">View &amp EdiT FIR</a></li>
...
<p>&nbsp;</p>
    ...
    <td width="720" valign="top" class="contentArea"><table width="100%" border="0" cellspacing="0" cellpadding="20">
        <tr>
          <td>
<h1><font style ="text-shadow: 4px 4px 4px #aaa;"><p align="center" style="color:#990000; font-size:30px;font-weight:bold;" >Online FIR</p></font></h1></td></tr>
<tr>
<img src="p.jpg"  style="float:left;border:0px; padding:0px; height="300" width="720"/>
